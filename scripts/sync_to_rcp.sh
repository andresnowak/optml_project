...
USER="${USER:-nowak}"
REMOTE_DIR="${REMOTE_DIR:-/home/${USER}/developer/optml_project}"
DRY_RUN="${DRY_RUN:-0}"
...
echo "Ensuring container entry script is executable"
ssh "${REMOTE_HOST}" "chmod +x '${REMOTE_DIR}/scripts/container_entry.sh'"
